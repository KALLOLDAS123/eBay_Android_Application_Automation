...
public class Component_TextBox {
	...
	public void Textboxavailabilityverification(String expected_textbox_text){
		 ...
		 * ================================================================
		 * */
		Assert.assertEquals(Actual_textbox_text, expected_textbox_text, "Text is verified and matching");
...
public void SearchtextBoxTextEnterpass(String TexttoEnter){
	
	try {
		WebDriverWait wait = new WebDriverWait(Common_Utilities.driver,2000);
		
		wait.until(ExpectedConditions.visibilityOf(element));
		element.sendKeys("NEW DEVANTI 65");
		Thread.sleep(1000);
		//element.submit();
	} catch (WebDriverException e) {
		// TODO Auto-generated catch block
