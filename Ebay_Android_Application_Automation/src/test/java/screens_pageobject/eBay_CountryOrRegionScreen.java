...
/*Common_Utilities common = new Common_Utilities();
	...
	public MobileElement CountryRegionoptions;
	
	@AndroidFindBy(xpath="//android.widget.Switch[@text='android:id/switch_widget']")
	public MobileElement autoselectionOff;
	
	//@AndroidFindBy(xpath="//android.widget.TextView[@resource-id='android:id/summary']")
	@AndroidFindBy(xpath="//android.widget.TextView[@text='Country / region']/../*[@class='android.widget.RelativeLayout']")
	//@AndroidFindBy(xpath="//android.widget.TextView[@text='Country / region']")
